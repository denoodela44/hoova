        ...
        <div className="space-y-2">
          {!user.store_name && (
            <button onClick={() => setTab('store')}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all hover:bg-gray-50"
              style={{ background: 'white', border: '1px solid #f0eeeb', borderLeft: '3px solid #B81365' }}>
              <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: '#fdf2f5' }}>
                <Edit2 className="w-4 h-4" style={{ color: '#B81365' }} />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-gray-900">Set your display name</p>
                <p className="text-xs text-gray-400 mt-0.5">Buyers see your email username — add a name so they know who you are.</p>
              </div>
          ...
          {!user.phone_verified && (
            <button onClick={() => setTab('account')}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all hover:bg-gray-50"
              style={{ background: 'white', border: '1px solid #f0eeeb', borderLeft: '3px solid #1d4ed8' }}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 mt-0.5">Verified sellers get 3× more enquiries. Takes 30 seconds.</p>
              </div>
              <ChevronRight className="w-4 h-4 shrink-0 text-gray-300" />
            </button>
          )}
